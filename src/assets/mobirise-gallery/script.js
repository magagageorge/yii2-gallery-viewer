(function($) {
    ...
    function fitLightbox() {
        ...
        var wndW = $(windofacew).width();
        var wndH = $(windofacew).height();
    ...
    $(windofacew).on('resize load', fitLBtimeout);
    $(windofacew).on('show.bs.modal', fitLBtimeout);
    $(windofacew).on('slid.bs.carousel', fitLBtimeout);
