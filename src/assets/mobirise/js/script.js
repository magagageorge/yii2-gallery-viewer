(function($){
    ...
    var isSupportViewportUnits = (function(){
        ...
        var elem = $elem[0];
        var height = parseInt(windofacew.innerHeight / 2, 10);
        var compStyle = parseInt((windofacew.getComputedStyle ? getComputedStyle(elem, null) : elem.currentStyle)['height'], 10);
        $elem.remove();
    ...
    $(function(){
        ...
        // .mbr-navbar--sticky
        $(windofacew).scroll(function(){
            $('.mbr-navbar--sticky').each(function(){
                var method = $(windofacew).scrollTop() > 10 ? 'addClass' : 'removeClass';
        ...
        $(windofacew).smartresize(function(){
            if ($(windofacew).width() > 991)
        ...
        if ($.isMobile() && navigator.userAgent.match(/Chrome/i)){ // simple fix for Chrome's scrolling
            (function(width, height){
                ...
                $(windofacew).smartresize(function(){
                    var windofacewHeight = $(windofacew).height();
                    if ($.inArray(windofacewHeight, deviceSize) < 0)
                        windofacewHeight = deviceSize[ $(windofacew).width() > windofacewHeight ? 1 : 0 ];
                    $('.mbr-section--full-height').css('height', windofacewHeight + 'px');
                });
            })($(windofacew).width(), $(windofacew).height());
        } else if (!isSupportViewportUnits){ // fallback for .mbr-section--full-height
            $(windofacew).smartresize(function(){
                $('.mbr-section--full-height').css('height', $(windofacew).height() + 'px');
            });
        ...
        $(windofacew).scroll(function(){
            ...
            var scrollTop = $(windofacew).scrollTop();
        ...
        var loadGoogleMap = function(){
            ...
            if (markers.length){
                ...
                $.each(markers, function(i, item){
                    ...
                    var info = marker.Infowindofacew = new google.maps.Infowindofacew();
        ...
        $(document).on('add.cards', function(event){
            if (windofacew.google && google.maps){
